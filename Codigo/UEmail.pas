...
begin
 ...
 If
           MessageDlg ('Você tem certeza que deseja Enviar o Email ?',
                       mtInformation,
                       [mbyes,mbno],
                       0)
          = mrno Then Begin
  ...
  try
   ...
   CaminhoAnexo := EmailAnexo.FileName;

   if FileExists(CaminhoAnexo) then
    begin
         TIdAttachment.Create(IdMessage.MessageParts, CaminhoAnexo);
         //TIdAttachment.Create(idmessage.MessageParts, 'C:\Users\allan\Desktop\Profissionais.pdf');
    end;
  ...
  // Envio da mensagem
    try
      ...
      Emails.Caption :=  'Casa de Repouso Jardim das Lores - Email enviado com Sucesso !';
      MessageDlg('Mensagem enviada com Sucesso.', mtInformation, [mbOK], 0);
      EmailAnexo.CleanupInstance;
      Label4.caption :='Caminho do Anexo : ';
    except
      On E:Exception do
...
procedure TEmails.anexoClick(Sender: TObject);
begin
EmailAnexo.Execute;
