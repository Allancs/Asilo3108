...
Corpo.Caption :=
'Eu '+NomeRes+' inscrito(a) no CPF sob o nº '+cpf.Text+' e no RG nº '+rg.Text+','+#13+'por meio deste documento declaro me responsabilizar pelo bem estar de, '+NomeResi+','+#13+
'residente da Casa de Repouso Jardim das Flores,'+#13+'pelo(s) dias a partir de '+DataS+' hora : '+Horas+ ', até '+DataC+' hora: '+HoraC+'.'+
''+#13+#13+
